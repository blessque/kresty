...
/** ROUND 30: the client's `references/О Крестах.docx`, one entry per paragraph */
const LEAD = [
  'Больше века «Кресты» были местом, где стены определяли границы человеческой свободы.',
  'Но история меняется.',
  'Сохраняя архитектуру и память прошлого, «Кресты» открываются городу — как ' +
    'пространство для жизни, движения, встреч и собственного выбора.',
  'Здесь можно прийти за знанием и остаться ради впечатлений. Остановиться, когда ' +
    'хочется тишины. Встретиться, когда хочется общения. Узнать новое, сменить ' +
    'привычный ритм, выбрать свой сценарий.',
  'Потому что свобода начинается не за стенами. Она начинается внутри человека — ' +
    'с возможности чувствовать, хотеть, выбирать и двигаться дальше.',
];
